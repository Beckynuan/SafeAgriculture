...
public class PurchaseActivity extends AppCompatActivity {
    ...
    private String t1_url,t2_url,t3_url,t4_url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pt1=(TextView)findViewById(R.id.ETitle1);
        Pt2=(TextView)findViewById(R.id.EStatement1);
        Pt3=(TextView)findViewById(R.id.EChecklist1);
        Pt4=(TextView)findViewById(R.id.Etext1);
...
//                    updateLanguage(true);
    ...
    public void executeLoopjCall() {
        ...
        new AsyncHttpClient().get(t3_url, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                String str = new String(responseBody);
                Pt3.setText(str);
        ...
        new AsyncHttpClient().get(t4_url, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                String str = new String(responseBody);
                Pt4.setText(str);
