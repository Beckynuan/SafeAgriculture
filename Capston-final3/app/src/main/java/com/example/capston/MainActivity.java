...
public class MainActivity extends AppCompatActivity {
  ...
  /*      mSwitch = (Switch) findViewById(R.id.btn_layout);
        ...
        mainFragment1 = new MainFragment1();//英文
        mainFragment2 = new MainFragment2();//中文
    }
...
//            mSwitch.setChecked(true);
            ...
            if (mFragment==null||mFragment == mainFragment1) {
                switchFragment(mainFragment2);
            }
            //修改标题
...
//            mSwitch.setChecked(false);
            ...
            if (mFragment==null||mFragment == mainFragment2) {
                switchFragment(mainFragment1);
            }
        }
    }
